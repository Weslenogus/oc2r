...
The computer case has no display of its own, so one of these is how you see what a machine is doing at all. A second one is a second view of the same computer: a wall of them, or a screen somewhere the computer is not.
